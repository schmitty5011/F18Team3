...
<main>
    ...
    <form action="." method="post" id="register_form">
        ...
        <input type="text" name="email"
               value="<?php echo htmlspecialchars($email); ?>" size="30" required>
        <?php echo $fields->getField('email')->getHTML(); ?><br>

        <label>Password:</label>
        <input type="password" name="password_1" size="30" required>
        <?php echo $fields->getField('password_1')->getHTML(); ?>
        <span class="error"><?php echo htmlspecialchars($password_message); ?></span><br>

        <label>Retype Password:</label>
        <input type="password" name="password_2" size="30" required>
        ...
        <label>Phone:</label>
        <input id = "ship_phone" type="text" name="ship_phone"
