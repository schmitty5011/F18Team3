    ...
    <div id="admin_div">
        ...
        <?php if (isset($_SESSION['admin'])) : ?>
            ...
            <form action="." method="post">
                ...
                <input id="non-underline-links_admin" type="submit" value="Edit">
            </form>
<?php endif; ?>
            ...
            ?>
                            ...
                            <td>
                                ...
                                <form action="." method="post" class="inline">
                                    ...
                                    <input type="hidden" name="admin_id"
                                           value="<?php echo $admin['adminID']; ?>">
                                    <input id="non-underline-links_admin" type="submit" value="Delete">
                                </form>
                            </td>
                        </tr>
        <?php endif; ?>
...
<?php echo $fields->getField('password_2')->getHTML(); ?><br>
            ...
            <label>&nbsp;</label>
            <input id="non-underline-links_admin_l" type="submit" value="Add Admin User">
        </form>
    </div>
</main>
