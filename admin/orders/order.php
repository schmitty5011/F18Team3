...
<?php if ($order['shipDate'] === NULL) : ?>
            ...
            <form action="." method="post" >
                ...
                <input id="non-underline-links_admin" type="submit" value="Ship Order">
            </form>
            <form action="." method="post" >
                <input type="hidden" name="action" value="confirm_delete">
                <input type="hidden" name="order_id"
                       value="<?php echo $order_id; ?>">
                <input id="non-underline-links_admin" type="submit" value="Delete Order">
            </form>
        ...
        <p><?php echo htmlspecialchars($ship_line1); ?><br>
            ...
            <?php endif; ?>
            <?php echo htmlspecialchars($ship_city); ?>, <?php echo htmlspecialchars($ship_state); ?>
...
?></p>
        ...
        <p><?php echo htmlspecialchars($bill_line1); ?><br>
            ...
            <?php endif; ?>
            <?php echo htmlspecialchars($bill_city); ?>, <?php echo htmlspecialchars($bill_state); ?>
